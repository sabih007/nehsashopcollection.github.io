        ...
        @endif
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                 <h1 class="welcome-text">Welcome to nehsashop collection </h1>
                
                </div>
                <div class="d-flex justify-center mt-2">
                    <a href="{{route('customers.index')}}" class="btn btn-secondary btn-sm">Click here to see  Customers List</a>
