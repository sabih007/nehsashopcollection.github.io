@include('layout.header')
    <div class="container">
        <div class="d-flex justify-content-between py-4">
            <h4><i class="fa fa-user-plus mr-2"></i> Create Customers List</h4>
            <a href="{{ route('customers.index') }}" class="btn btn-primary"> <i class="fa fa-arrow-left"></i> back</a>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-header d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" id="myWish" href="javascript:;">
                    Processed & save <i class="fa fa-arrow-right"></i></button>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-lg-6  my-2">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="order_no" name="order_no"
                                    ...
                                    placeholder="Enter Order Number" value="{{ old('order_no') }}">
                                @error('order_no')
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="order_details" name="order_details"
                                    ...
                                    placeholder="Enter Order Details" value="{{ old('order_details') }}">
                                @error('order_details')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="delivery_charges" name="delivery_charges"
                                    ...
                                    placeholder="Enter Payment Method" value="{{ old('delivery_charges') }}">
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="delivery_zone" name="delivery_zone"
                                    ...
                                    placeholder="Enter Delivery Zone" value="{{ old('delivery_zone') }}">
                                @error('delivery_zone')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
